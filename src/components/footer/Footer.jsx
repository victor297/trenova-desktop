...
const Footer = () => {
  return (
    <div className="flex w-full flex-col items-center justify-between mt-auto px-1 pb-8 pt-3 lg:px-8 xl:flex-row">
      <h5 className="text-sm mb-4 text-center font-medium text-gray-900 sm:!mb-0 md:text-lg">
        <p className="text-sm md:text-base mb-4 text-center text-gray-900 sm:!mb-0">
