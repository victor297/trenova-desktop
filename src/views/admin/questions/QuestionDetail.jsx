...
import { FaVideo, FaQuestionCircle, FaCheck, FaArrowLeft, FaArrowRight, FaChevronDown, FaChevronUp } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 bg-white">
      ...
      {question.content.map((week, weekIndex) => (
        <div key={week._id} className="mb-8 bg-white rounded-lg shadow-md px-2 ">
          <div className="flex justify-between items-center cursor-pointer p-6" onClick={() => toggleWeekCollapse(weekIndex)}>
            <h2 className="text-2xl font-semibold text-orange-500 mb-4">
              {week.week}
            </h2>
            <div>
              {collapsedWeeks[weekIndex] ? <FaChevronDown /> : <FaChevronUp />}
            </div>
          </div>
